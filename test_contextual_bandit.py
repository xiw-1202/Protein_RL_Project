"""
Test Contextual Bandit vs baselines
"""
...
def main():
    print("=" * 70)
    print("CONTEXTUAL BANDIT vs BASELINES")
    print("=" * 70)
    ...
    # Initialize oracle (using small model for speed)
    ...
    for method, res in results.items():
        ...
        if "improvements" in res:
            print(f"  Accepted:     {res['improvements']}")
    ...
    ax.set_title("Sample Efficiency Comparison (with RL)")
    ax.legend()
    ...
    print("\n✓ Plot saved: bandit_comparison.png")
